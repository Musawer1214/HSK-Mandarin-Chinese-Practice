...
document.querySelector('#creatorCredit').insertAdjacentHTML('beforebegin','<div style="margin-top:18px"><button id="githubUpdates">Check updates on GitHub</button><p class="footnote">Version 1.2.0 · Opens GitHub in your browser. Install updates over this app to keep your progress.</p></div>');
