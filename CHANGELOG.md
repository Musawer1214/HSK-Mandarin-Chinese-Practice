...
- Check updates on GitHub button in Help & backups, opening the system browser.
- Existing phone recall and listening progress retained by signed updates.

## 1.1.1

- Creator credit: A personal creation by Musawer Hussain Orakzai.

## 1.1.0

- Offline listening quiz with four Chinese and four English choices.
- Separate saved listening progress and compact mobile layout.

## 1.0.0

- Offline classic HSK 1–3 recall, weak-word tracking, audio and backups.
